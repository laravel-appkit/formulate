...
class FromValuesTest extends TestCase
{
    ...
    public function formsCanHaveDataPassedToThemAsAnArray()
    {
        ...
        $view = $this->blade('<x-formulate::form :data="$data"></x-formulate::form>', compact('data'));
    ...
    public function inputComponentsCanHaveADefaultValue()
    {
        ...
        $view = $this->blade('<x-formulate::form :data="$data">
            <x-formulate::input name="my-input" value="Default Value" />
    ...
    public function inputComponentsCanGetDataValueFromModel()
    {
        ...
        // render the blade component
        $view = $this->blade('<x-formulate::form :data="$data">
            <x-formulate::input name="title" value="Default Value" />
        </x-formulate::form>', compact('data'));
    ...
    public function inputComponentsUseDefaultValueIfTheAttributeIsNotOnAModel()
    {
        ...
        // render the blade component
        $view = $this->blade('<x-formulate::form :data="$data">
            <x-formulate::input name="author" value="Default Value" />
        </x-formulate::form>', compact('data'));
    ...
    public function multipleInputComponentsCanHaveOldValues()
    {
        ...
        $view = $this->blade('<x-formulate::form :data="$data">
            <x-formulate::input name="my-input" value="Default Value" />
            <x-formulate::input name="my-input2" value="Default Value" />
        </x-formulate::form>', compact('data'));
    ...
    public function inputsCanGetDataFromVariousSources()
    {
        ...
        $view = $this->blade('<x-formulate::form :data="$data">
            <x-formulate::input name="my-input" value="Default Value" />
            <x-formulate::input name="my-input2" value="Default Value 2" />
            <x-formulate::input name="my-input3" value="Default Value 3" />
        </x-formulate::form>', compact('data'));
