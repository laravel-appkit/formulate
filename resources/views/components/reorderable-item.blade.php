<div
    ...
    :class="
    {
        ...
        'pt-20 old-bg-indigo-500': droppingIndex == index && draggingIndex > index,
        'pb-20 old-bg-blue-500': droppingIndex == index && draggingIndex < index
    }
    "
    class="flex flex-row relative transition-spacing duration-300 ease-in-out"
>
    {{ $slot }}
    ...
    <div
        ...
        @drop.prevent="{{ $source }}.splice(droppingIndex, 0, {{ $source }}.splice(draggingIndex, 1)[0]); draggable = false"
